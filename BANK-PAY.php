...
$sql = "SELECT  upi FROM dbo.dbo.notice WHERE id='1'";
...
$sql1 = "INSERT INTO dbo.dbo.recharge (username, recharge,status,upi,utr,rand) VALUES ('".$_SESSION['username']."', '$amount','To Be Paid','$upi','$utr','$rand')";
