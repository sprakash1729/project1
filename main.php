...
require_once "config.php";
$sql = "SELECT  dbo.notice FROM dbo.notice WHERE id='1'";
$result = $conn->query($sql);
$row = mysqli_fetch_array($result);
$notice=$row['notice'];

$sql = "SELECT  nickname,created_at,balance FROM dbo.dbo.users WHERE username='".$_SESSION['username']."'";
$result = $conn->query($sql);
$row = mysqli_fetch_array($result);
...
$sql = "UPDATE dbo.dbo.users SET nickname= '$nickname',created_at='$created_at',balance='$balance' WHERE username='".$_SESSION['username']."'";
