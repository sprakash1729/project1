...
if (empty($_POST["Address"] )== false){
                ...
                $query0 =  "SELECT  Address FROM dbo.dbo.users  WHERE username!='".$_SESSION['username']."' AND Address='$Address'";
$result3 =$conn->query($query0);
$row3 = mysqli_fetch_assoc($result3);
$first=$row3['Address'];
                if($first==''){
                      $sql = "UPDATE dbo.dbo.users SET Address ='$Address', Address ='$Address',name='$name',upi='$upi',email='$email' WHERE username='".$_SESSION['username']."' ";
