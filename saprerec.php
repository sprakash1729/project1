...
$query =  "SELECT * FROM dbo.saprebetting ORDER BY id DESC";
...
$query = "SELECT *FROM dbo.saprebetting WHERE username='".$_SESSION['username']."' ORDER BY id DESC OFFSET " . $page_first_result . ',' . $results_per_page;  
$result = mysqli_query($conn, $query);
$status1 = '';
$amount = '';
