...
$sql1 = "INSERT INTO dbo.recharge (username, recharge,status,upi,utr) VALUES ('".$_SESSION['username']."', '$amount','RIGHT-PAY','$upi','$utr')";
...
<link rel="stylesheet" href="https://www.91dreamclub.com/includes/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="https://www.91dreamclub.com/includes/assets/css/light.css?06.13">
<link rel="stylesheet" href="https://www.91dreamclub.com/includes/dropzone/css/dropzone.css?06.13">
...
<div class="upi-payment-step">
			<div class="row mt-4">
				<div class="col-2 xtc pa-0"><img class="" src="https://91dreamclub.com/includes/icons/tick_p.svg" height="35"></div>
...
<input id="text" type="hidden" name="amount" value="<?php echo $am;?>"  />
    ...
    background-size: contain;
				...
				<!--</div>-->
				<div class="col-2 mt-3 xtc pa-0"><img id="rcagnt" class="dhkm" src="https://91dreamclub.com/includes/icons/comp.png" height="40"></div>
				...
				<div class="col-2 xtc pa-0"><img id="rccmp" class="dhkm" src="https://91dreamclub.com/includes/images/tick_inac.png" height="35"></div>
