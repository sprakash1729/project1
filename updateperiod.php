...
$sql = "UPDATE dbo.period SET period='$username'";
   
$sql1 = "UPDATE dbo.beconeperiod SET period='$username'";
   
$sql2 = "UPDATE dbo.emredperiod SET period='$username'";
   
$sql3 = "UPDATE dbo.sapreperiod SET period='$username'";
